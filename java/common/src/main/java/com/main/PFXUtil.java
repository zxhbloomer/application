...
public class PFXUtil {
    ...
    public static void main(String[] args) throws Exception {
        String pfxPath = "C:\\Users\\Administrator\\Desktop\\https\\file.pfx";
        String password = "QYA3kRx5";
        //私钥：pfx文件中获取私钥对象
...
//        //PFX：合成pfx（需要私钥、公钥证书）
//        String savePath = generatorPFX(privateKey, certificate, "QYA3kRx5", new File("C:\\Users\\49383\\Desktop\\文件\\009\\009.pfx"));
