...
import static com.main.demo.util.ConvertWrapperUtil.convertWrapper;
...
public class MyBatisPlusApplicationTest {
	...
	public void testVqoConvert() throws Exception{
		...
		IPage<SysResource> page  = resourceService.page(new Page<SysResource>(1,2), convertWrapper(vqo));
